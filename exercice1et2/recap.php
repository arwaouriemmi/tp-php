<?php
$s_nom=htmlentities($_POST['nom']);
$s_prenom=htmlentities($_POST['prenom']);
$s_nb=htmlentities($_POST['nb_sandwitch']);
$s_adr=htmlentities($_POST['adresse']);
 ...
 echo("details de votre commande : <br> votre nom est : $s_nom votre prénom est : $s_prenom <br>  votre adresse est $s_adr <br> le nombre de sandwitch voulu est : $s_nb <br>");
 for ($i=0; $i<$s_nb; $i++) {
